...
Flatulence is a universal physiological phenomenon, yet surprisingly little attention has been devoted to one seemingly simple question: **does a fart have weight?**
...
Researchers have measured the composition of intestinal gases [1][2], quantified daily gas production [3], identified the microbial origin of methane [4], characterized sulfur-containing odor compounds [5], and established the thermodynamic properties necessary for calculating gas density [6].

Individually, none of these studies asks whether a fart has weight.
...
Subsequent research revealed substantial variability between individuals.

Diet, gut microbiota, intestinal transit time, carbohydrate fermentation, and gastrointestinal disorders all influence both the volume and composition of flatus [2][3].
...
Together, these studies establish the biological foundation necessary for the physical analysis developed in the following sections.

---

# 3. Chemical Composition of Human Flatus
...
Only individuals whose intestinal microbiome contains methanogenic archaea produce measurable methane [4]. Consequently, two healthy individuals may produce gases with noticeably different chemical compositions.
...
For the remainder of this paper, the average gas composition reported in published physiological studies will be used to estimate the molecular weight of a representative human fart.
...
1. Estimate the average chemical composition of human flatus.
2. Calculate its average molar mass.
3. Assume physiological temperature (37 °C) and atmospheric pressure.
4. Apply the Ideal Gas Law to determine the number of moles contained in a given volume.
...
# 5. Calculating the Average Molar Mass

Each component contributes to the overall molecular weight according to its relative abundance.
...
# 6. Estimating the Mass of a Typical Fart
...
However, the physical consequences become considerably more interesting once buoyancy is taken into account.

---

# 7. The Bathroom Scale Paradox

At this point, the conclusion appears straightforward.

A fart consists of molecules.

Those molecules possess mass.

When they leave the body, the body's mass decreases by exactly the amount of gas expelled.
...
## 7.1 Mass versus Apparent Weight

Most people use the terms *mass* and *weight* interchangeably.

Physically, however, they describe different quantities.

Mass measures the amount of matter contained in an object.

Weight is the gravitational force acting on that mass.

Bathroom scales introduce another subtlety: they measure **apparent weight**, which is affected by buoyancy.
...
## 7.2 Why Intestinal Gas Produces Buoyancy

The average density of human flatus is slightly lower than that of atmospheric air.
...
Once expelled, that buoyancy disappears.

The resulting decrease in buoyant force is slightly larger than the reduction in mass caused by releasing the gas.

Consequently, an extremely sensitive scale would briefly register a **small increase in apparent weight immediately after a fart**.
...
Like any scientific estimate, the calculations presented in this paper rely on simplifying assumptions.

The largest sources of uncertainty include:

- Natural variation in intestinal gas composition between individuals.
- Daily fluctuations caused by diet.
- The presence or absence of methane-producing microorganisms.
...
By combining those findings with elementary physical principles, it becomes possible to estimate something that, surprisingly, has never been explicitly reported in the scientific literature.
...
A typical human fart contains measurable mass.

Using published physiological data together with the Ideal Gas Law, the estimated mass of an average fart is approximately **0.10 grams**, while unusually large volumes may approach **0.50 grams**.

This value is remarkably small but unquestionably real.

Perhaps the most surprising finding, however, is not the mass itself.
...
Even fewer end with a result that appears to contradict common sense.

That, perhaps, is what makes the question worth asking.
